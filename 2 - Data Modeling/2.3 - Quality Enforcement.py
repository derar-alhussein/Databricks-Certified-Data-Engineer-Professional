...
# MAGIC INSERT INTO orders_silver
# MAGIC VALUES ('1', '2022-02-01 00:00:00.000', 'C00001', 0, 0, NULL),
# MAGIC        ('2', '2020-05-01 00:00:00.000', 'C00001', 0, 0, NULL),
# MAGIC        ('3', '2023-01-01 00:00:00.000', 'C00001', 0, 0, NULL)
...
# MAGIC %sql
# MAGIC -- Step 1: Identify the rows that violate the constraint
# MAGIC SELECT * FROM orders_silver WHERE quantity <= 0;
# MAGIC
# MAGIC -- Step 2: Update or delete the violating rows
# MAGIC -- Option 1: Update the violating rows
# MAGIC UPDATE orders_silver SET quantity = 1 WHERE quantity <= 0;
# MAGIC
# MAGIC -- Option 2: Delete the violating rows
# MAGIC DELETE FROM orders_silver WHERE quantity <= 0;
# MAGIC
# MAGIC -- Step 3: Add the CHECK constraint
# MAGIC ALTER TABLE orders_silver ADD CONSTRAINT valid_quantity CHECK (quantity > 0);
